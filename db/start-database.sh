...
DB_CONTAINER_NAME="kapuut-database"
...
docker run --name $DB_CONTAINER_NAME -e POSTGRES_PASSWORD=$DB_PASSWORD -e POSTGRES_DB=$DB_CONTAINER_NAME -d -p 5432:5432 docker.io/postgres
